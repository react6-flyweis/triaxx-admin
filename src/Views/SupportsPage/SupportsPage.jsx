...
import SupportTypeDialog from "../../Components/Supports/SupportTypeDialog";
import AddSupportTicketTypeDialog from "../../Components/Supports/AddSupportTicketTypeDialog";
...
const SupportsPage = () => {
  ...
  const activeTickets = (ticketTypes || []).filter(
    (t) => t.Status === true
  ).length;
  const inactiveTickets = (ticketTypes || []).filter(
    (t) => t.Status === false
  ).length;
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Manage your support ticket categories
          </p>
        </div>
        <div className="flex gap-3">
          ...
          <button
            ...
            className="px-4 py-2 bg-linear-to-b from-purple-700 to-red-600 text-white rounded-lg hover:shadow-lg transition-shadow flex items-center gap-2"
          >
