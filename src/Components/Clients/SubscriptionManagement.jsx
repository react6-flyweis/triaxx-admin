...
function SubscriptionManagement() {
    ...
    >
      ...
      <div
        className={`absolute top-1 w-6 h-6 bg-white rounded-full shadow-md transition-all duration-300 ${
          isOn ? "transform translate-x-8 shadow-lg" : "transform translate-x-1"
        }`}
      />
      ...
      <div className="absolute inset-0 flex items-center justify-between px-2 text-xs font-semibold pointer-events-none">
        ...
        <span
          className={`transition-opacity duration-300 ${
            !isOn ? "opacity-100 text-gray-600" : "opacity-0"
          }`}
        >
          OFF
        </span>
  ...
  return (
    <div className=" p-6 bg-white">
            ...
            <div className="flex gap-10">
              ...
              <div className="flex flex-col gap-2 w-80">
                <div className="flex items-center px-2 gap-2 w-32 h-7">
                  <h3 className="text-lg font-semibold text-black font-manrope">
                    Current Plan
                  </h3>
                </div>
                <div
                ...
                <div className="flex items-center gap-8 w-72 h-14">
                  ...
                  >
                    <div className="absolute inset-0 flex items-center justify-between px-6">
                      <span className="text-lg font-semibold text-black font-manrope">
                        2 weeks ago
                      </span>
                      <Toggle
              ...
              <div className="relative">
                ...
                >
                  <p className="text-base font-normal text-black font-poppins leading-6 tracking-wide">
                    Hey ABC Restaurant, We have an Amazing Renewal Plan for you.
                    The validity of the Offer is going to end in 3 days. Grab it
                    soon before the prices of Subscriptions increases.
                  </p>
                </div>
              </div>
            </div>
      ...
      {showModal && (
        <SubscriptionManagementModal onClose={() => setShowModal(false)} />
      )}
    </div>
  );
}

const SubscriptionManagementWithLayout = withAdminLayout(
  SubscriptionManagement
);
export default SubscriptionManagementWithLayout;
