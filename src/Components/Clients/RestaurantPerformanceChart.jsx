  ...
  return (
    <button
      ...
      className={`px-2 sm:px-3 py-1 rounded-md text-xs sm:text-sm font-medium transition-colors ${
        isActive ? "text-white" : "bg-gray-200 text-gray-600 hover:bg-gray-300"
      }`}
      style={
        isActive
...
const RestaurantPerformanceChart = ({ chartData: externalChartData }) => {
  const [selectedPeriod, setSelectedPeriod] = useState("24H");

  // Default sample chart data (fallback)
  ...
  // Prefer externally-provided chart data when available
  const chartData =
    Array.isArray(externalChartData) && externalChartData.length
      ? externalChartData
      : defaultChartData;
        ...
        <ResponsiveContainer width="100%" height="100%">
          ...
          >
            ...
            <XAxis
              ...
              interval={
                window.innerWidth < 640 ? 6 : window.innerWidth < 1024 ? 5 : 4
              }
