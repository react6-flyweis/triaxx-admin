    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="p-0 rounded-2xl border-0 sm:max-w-lg w-full max-h-[90vh] overflow-y-auto">
        <div className="p-8 flex flex-col items-center gap-6 text-center">
          ...
          <div className="size-40 rounded-full bg-[#34C759] flex items-center justify-center">
            <CheckCircle size={76} className="text-white" />
          </div>
          ...
          <DialogFooter className="w-full">
            <div className="flex gap-3 w-full justify-center">
              ...
              <button
                ...
                className="px-6 py-3 w-40 rounded-lg bg-green-500 text-white font-semibold"
              >
                {ctaText}
              </button>
            </div>
